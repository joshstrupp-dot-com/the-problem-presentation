/**
 * Chapter 2 Main application entry point
 * Initializes the scrollytelling functionality for Chapter 2
 */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Preload data specifically for chapter 2
  ...
  function init() {
    // Clear localStorage to always use the configuration from chapter2-steps-config.js
